...
void propagate_ref(std::shared_ptr<ExecutionCtx>& ctx, Term dst, Any* value) {
...
void propagate_value(std::shared_ptr<ExecutionCtx>& ctx, Term dst, Any value) {
...
void propogate_outputs(std::shared_ptr<ExecutionCtx>& ctx, const ValueForward& fwd, Any& value) {
